...
Функция ОписаниеКоманд() Экспорт
	...
	ОписаниеКоманд.Вставить(Перечисления.ТипыКонтактнойИнформации.Slack, КомандыТипаКонтактнойИнформации(
		Перечисления.ТипыКонтактнойИнформации.Slack));
	ОписаниеКоманд.Вставить(Перечисления.ТипыКонтактнойИнформации.Telegram, КомандыТипаКонтактнойИнформации(
		Перечисления.ТипыКонтактнойИнформации.Telegram));
