...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	//Списки.Вставить(Метаданные.Справочники.док_АТС, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_БД, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_БДПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Боты, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ВерсииКонфигураций, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ВерсииПлатформы1С, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Видеорегистраторы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ВидеорегистраторыПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ВидыКомплектующих, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ВидыУстройств, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Домены, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ДоменыПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Кассы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_КассыПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Клиенты, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_КлиентыПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_КонтактныеЛицаКлиентов, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Конфигурации, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Лицензии, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ЛицензииПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_МестоположенияТехники, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_НазначенияПортов, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_НазначенияПортов, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ОперационныеСистемы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Принтеры, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_ПринтерыПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Серверы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_СерверыVPN, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_СерверыVPNПрисоединенныеФайлы, Истина); 
	//Списки.Вставить(Метаданные.Справочники.док_СерверыПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Сервисы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_СетевоеОборудование, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_СетевоеОборудованиеПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Сети, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_СетиПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_СУБД, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_СУБДПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_Устройства, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_УстройстваПрисоединенныеФайлы, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_УстройстваСУдаленнымУправлением, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_УчетныеДанныеСервисов, Истина);
	//Списки.Вставить(Метаданные.Справочники.док_УчетныеДанныеСервисовПрисоединенныеФайлы, Истина);	
