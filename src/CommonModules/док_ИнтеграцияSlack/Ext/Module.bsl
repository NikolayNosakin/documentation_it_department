...
Процедура ОтправитьСообщение(Структура, SlackBotToken) Экспорт
...
Процедура ЗаписатьИсторию(Структура) Экспорт
	...
	НоваяЗапись = РегистрыСведений.док_Slack_ИсторияСообщений.СоздатьМенеджерЗаписи();
