...
Функция КартинкиТиповКонтактнойИнформации() Экспорт
	...
	КартинкиТиповКонтактнойИнформации.Вставить(Перечисления.ТипыКонтактнойИнформации.Slack, БиблиотекаКартинок.док_Slack);
	КартинкиТиповКонтактнойИнформации.Вставить(Перечисления.ТипыКонтактнойИнформации.Telegram, БиблиотекаКартинок.Телеграм16х16);
