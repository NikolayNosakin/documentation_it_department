			...
			Исключение
				ЗаписьЖурналаРегистрации(
					...
					НСтр("ru = 'Не удалось отключить проверку удаляемых объектов по причине:';
						|en = 'Cannot disable check of marked objects due to:'")
	...
	Если Ошибки.Количество() > 0 Тогда
		...
		ЗаписьЖурналаРегистрации(
			...
			НСтр("ru = 'Не удалось установить пометку удаления для объектов:';
				|en = 'Couldn''t mark the following objects for deletion:'") + Символы.ПС + СтрСоединить(ТекстОшибки, Символы.ПС + Символы.ПС));
...
Процедура ЗапретитьИспользованиеУдаляемыхОбъектов(Источник, Отказ)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
				...
				УровеньЖурналаРегистрации.Ошибка, , ,
				НСтр("ru = 'Не удалось выполнить контроль удаляемых объектов:';
					|en = 'Cannot control objects to be deleted:'") + ПодробноеПредставлениеОшибки(Ошибка));
	КонецПопытки;
