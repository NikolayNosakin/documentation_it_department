...
Процедура ДобавитьГруппуОператоровРазделители(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, " ", НСтр("ru = 'Пробел';
												|en = 'Whitespace'"), Новый ОписаниеТипов("Строка"));
...
Процедура ДобавитьГруппуОператоровЧисловыеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "Цел", НСтр("ru = 'ЦелаяЧасть';
												|en = 'IntegerPart'"), Тип, Истина);
...
Процедура ДобавитьГруппуОператоровСтроковыеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "Строка", НСтр("ru = 'ПреобразоватьВСтроку';
													|en = 'ConvertToString'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ВРег", НСтр("ru = 'ВсеПрописные';
												|en = 'AllUppercase'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "НРег", НСтр("ru = 'ВсеСтрочные';
												|en = 'AllLowercase'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ТРег", НСтр("ru = 'КаждоеСловоСПрописной';
												|en = 'EachWordUppercase'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Лев", НСтр("ru = 'СимволыСлева';
												|en = 'CharactersLeft'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Прав", НСтр("ru = 'СимволыСправа';
												|en = 'CharactersRight'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СокрЛ", НСтр("ru = 'УбратьПробелыСлева';
													|en = 'RemoveSpacesLeft'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СокрЛП", НСтр("ru = 'УбратьПробелыСлеваИСправа';
													|en = 'RemoveSpacesLeftAndRight'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СокрП", НСтр("ru = 'УбратьПробелыСправа';
													|en = 'RemoveSpacesRight'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СтрЗаменить", НСтр("ru = 'ЗаменитьСимволыВСтроке';
														|en = 'ReplaceCharactersInString'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "СтрДлина", НСтр("ru = 'ДлинаСтроки';
													|en = 'StringLength'"), Новый ОписаниеТипов("Число"), Истина);
...
Процедура ДобавитьГруппуОператоровПрочиеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "ПредопределенноеЗначение", НСтр("ru = 'ПредопределенноеЗначение';
																	|en = 'PredefinedValue'"), Новый ОписаниеТипов, Истина);
	ДобавитьОператорВГруппу(Группа, "ЗначениеЗаполнено", НСтр("ru = 'ЗначениеЗаполнено';
																|en = 'ValueIsFilled'"), Новый ОписаниеТипов("Булево"), Истина);
...
Процедура ДобавитьГруппуОператоровРаботаСДатами(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "ДЕНЬГОДА", НСтр("ru = 'ДЕНЬГОДА';
													|en = 'DAYOFYEAR'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ДЕНЬ", НСтр("ru = 'ДЕНЬ';
												|en = 'DAY'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "НЕДЕЛЯ", НСтр("ru = 'НЕДЕЛЯ';
													|en = 'WEEK'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "ДЕНЬНЕДЕЛИ", НСтр("ru = 'ДЕНЬНЕДЕЛИ';
														|en = 'WEEKDAY'"), Тип, Истина);
	...
	ДобавитьОператорВГруппу(Группа, "НАЧАЛОПЕРИОДА", НСтр("ru = 'НАЧАЛОПЕРИОДА';
															|en = 'BEGINOFPERIOD'"), Новый ОписаниеТипов, Истина);
	ДобавитьОператорВГруппу(Группа, "КОНЕЦПЕРИОДА", НСтр("ru = 'КОНЕЦПЕРИОДА';
														|en = 'ENDOFPERIOD'"), Новый ОписаниеТипов, Истина);
	ДобавитьОператорВГруппу(Группа, "ДОБАВИТЬКДАТЕ", НСтр("ru = 'ДОБАВИТЬКДАТЕ';
															|en = 'DATEADD'"), Новый ОписаниеТипов, Истина);
	
	ДобавитьОператорВГруппу(Группа, "РАЗНОСТЬДАТ", НСтр("ru = 'РАЗНОСТЬДАТ';
														|en = 'DATEDIFF'"), Тип, Истина);
