...
Процедура ДобавитьГруппуОператоровФункцииДляТабличныхЧастей(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "УправлениеПечатью_СуммаПоКолонке", НСтр("ru = 'Сумма по колонке';
																			|en = 'Amount by column'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "УправлениеПечатью_КоличествоСтрок", НСтр("ru = 'Количество строк';
																				|en = 'Number of strings'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "УправлениеПечатью_МаксимумПоКолонке", НСтр("ru = 'Максимум по колонке';
																				|en = 'Maximum value by column'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "УправлениеПечатью_МинимумПоКолонке", НСтр("ru = 'Минимум по колонке';
																				|en = 'Minimum value by column'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "УправлениеПечатью_СреднееПоКолонке", НСтр("ru = 'Среднее по колонке';
