...
Процедура ОбновитьВариантыОтчетовИзФайлов(ОписаниеФайлов, СвойстваВариантаОтчетаОснования) Экспорт // АПК:299 является обработчиком оповещения (см. процедуру ОбновитьВариантОтчетаИзФайла модуля формы списка справочника ВариантыОтчетов).
	...
	ТекстУведомления = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Варианты отчетов (%1) загружены из файла';
			|en = 'Report options (%1) are imported from the file'"), СвойстваВариантовОтчетов.Количество());
...
Процедура ОбновитьВариантОтчетаИзФайла(ОписаниеФайла, СвойстваВариантаОтчетаОснования) Экспорт 
	...
	Если СвойстваВариантаОтчетаОснования.ИмяОтчета = СвойстваВариантаОтчета.ИмяОтчета Тогда 
		...
		ПоказатьОповещениеПользователя(НСтр("ru = 'Вариант отчета обновлен из файла';
											|en = 'The report option is updated from the file.'"));
	...
	ИначеЕсли СвойстваВариантаОтчетаОснования.ПредставлениеВарианта = СвойстваВариантаОтчета.ПредставлениеВарианта Тогда 
		...
		ПоказатьОповещениеПользователя(НСтр("ru = 'Вариант отчета найден и обновлен из файла';
											|en = 'The report option is found and updated from the file.'"));
