...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокФормы = НСтр("ru = 'Универсальный обмен данными в формате XML (%ВерсияОбработки%)';
							|en = 'Conversion Rule Data Exchange in XML format (%ВерсияОбработки%)'");
...
Процедура ВыполнитьВыгрузкуИзФормы()
	...
	Если ЭтоКлиент И Не ПрямаяВыгрузка И Не Объект.ФлагОшибки Тогда
		...
		ИмяСохраняемогоФайла = ?(Объект.АрхивироватьФайл, НСтр("ru = 'Файл выгрузки.zip';
																|en = 'Export file.zip'"),НСтр("ru = 'Файл выгрузки.xml';
																								|en = 'Export file.xml'"));
