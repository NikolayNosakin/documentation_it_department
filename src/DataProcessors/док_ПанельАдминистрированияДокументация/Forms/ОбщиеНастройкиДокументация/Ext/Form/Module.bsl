...
Процедура УстановитьДоступность()
	...
	Элементы.НастроитьОграничениеПользователейПоКонтрагентам.Доступность = НаборКонстант.док_ИспользоватьОграничениеRLS_ПоКонтрагентам;
КонецПроцедуры
...
Процедура СохранениеВосстановлениеДанных(Команда)
	ОткрытьФорму("ОбщаяФорма.док_СохранениеВосстановлениеДанных");
КонецПроцедуры
...
&НаКлиенте
Процедура НастроитьОграничениеПользователейПоКонтрагентам(Команда)
	ОткрытьФорму("Справочник.док_РазрешенныеКонтрагентыПользователей.ФормаСписка");
КонецПроцедуры
