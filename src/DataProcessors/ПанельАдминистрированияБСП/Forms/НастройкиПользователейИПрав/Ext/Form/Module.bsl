...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступностьФормы = док__ОбщегоНазначения.ПолучитьНастройкуПользователя(Пользователи.ТекущийПользователь(),"РазрешеноИзменятьПользователей");
	
КонецПроцедуры

&НаКлиенте
Процедура ПриОткрытии(Отказ)
	ЭтаФорма.Доступность = ДоступностьФормы;
	Элементы.ОткрытьПользователи.Доступность = ДоступностьФормы;
	Элементы.ВосстановлениеПаролей.Доступность = ДоступностьФормы;
	Элементы.НастройкиВхода.Доступность = ДоступностьФормы;
КонецПроцедуры
