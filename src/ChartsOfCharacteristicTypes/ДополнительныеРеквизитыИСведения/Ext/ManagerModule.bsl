		...
		Если МетаданныеВладельца = Неопределено Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при изменении настройки свойства %1.
				           ...
				           |en = 'An error occurred when changing settings of the ""%1"" property.
				           |The ""%2"" property set is not associated with any owner of property values.'"),
				Свойство,
				ТекущийНаборСвойств);
		КонецЕсли;
		...
		ИначеЕсли Свойство = СвойствоОбъект.Ссылка Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при изменении настройки свойства %1.
				           ...
				           |en = 'An error occurred when changing the ""%1"" property settings.
		...
		Исключение
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось обработать дополнительный реквизит (сведение) %1 по причине:
					|%2';
					|en = 'Couldn''t process additional attribute or information record: ""%1"". Reason:
					|%2'"), 
