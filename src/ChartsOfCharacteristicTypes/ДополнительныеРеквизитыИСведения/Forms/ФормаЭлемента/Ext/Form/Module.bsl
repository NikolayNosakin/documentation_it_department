...
Процедура ЗаполнитьСтраницуВыбора()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		ОбщиеНаборыСвойств, "ОбщиеДополнительныеСведения", НСтр("ru = 'Неиспользуемые дополнительные сведения';
																|en = 'Unused additional information records'"), Истина);
	
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		ОбщиеНаборыСвойств, "ОбщиеДополнительныеРеквизиты", НСтр("ru = 'Неиспользуемые дополнительные реквизиты';
																|en = 'Unused additional attributes'"), Истина);
...
Процедура УстановитьНастройкиПомощника(ТекущаяСтраница = Неопределено)
	...
	Если ТекущаяСтраница = Элементы.ВыборРеквизита Тогда
		...
		Элементы.ДекорацияЗаголовок.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			...
			?(ПереданныеПараметрыФормы.ЭтоДополнительноеСведение, НСтр("ru = 'дополнительное сведение';
																		|en = 'an additional information record'"), НСтр("ru = 'дополнительный реквизит';
																												|en = 'an additional attribute'")),
	...
	ИначеЕсли ТекущаяСтраница = Элементы.ВыборДействия Тогда
		...
		Элементы.РежимДобавленияРеквизита.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			...
			?(ПереданныеПараметрыФормы.ЭтоДополнительноеСведение, НСтр("ru = 'сведения';
																		|en = 'information record'"), НСтр("ru = 'реквизита';
																								|en = 'attribute'")),
...
Функция ИдентификаторДляФормулУжеИспользуется(Знач ИдентификаторДляФормул, Знач ТекущееСвойство)
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		ТекстВопроса + Символы.ПС + Символы.ПС
		                         ...
		                         |
		                         |Создать новый идентификатор для формул и продолжить запись?';
		                         |en = 'It is recommended that you use another ID for formulas.
