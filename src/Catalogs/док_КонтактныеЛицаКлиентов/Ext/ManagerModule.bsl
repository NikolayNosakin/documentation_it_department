...
Процедура ПриЗаполненииОграниченияДоступа(Ограничение) Экспорт
	...
	|ЭтотСписок КАК док_КонтактныеЛицаКлиентов
	|
	|ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ВнешниеПользователи КАК ВнешниеПользователиПартнеры
	|	ПО ВнешниеПользователиПартнеры.ОбъектАвторизации = док_КонтактныеЛицаКлиентов.Владелец
	|
	|ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ВнешниеПользователи КАК ВнешниеПользователиКонтактныеЛица
	|	ПО ВнешниеПользователиКонтактныеЛица.ОбъектАвторизации = док_КонтактныеЛицаКлиентов.Ссылка
	|;
	|РазрешитьЧтениеИзменение
	|ГДЕ
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СсылкиКОбработке = УправлениеКонтактнойИнформацией.ОбъектыТребующиеОбновленияКонтактнойИнформации(
		Метаданные.Справочники.док_КонтактныеЛицаКлиентов);
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	КонтактноеЛицоПартнера = ОбновлениеИнформационнойБазы.ВыбратьСсылкиДляОбработки(Параметры.Очередь, "Справочник.док_КонтактныеЛицаКлиентов");
	...
	Пока КонтактноеЛицоПартнера.Следующий() Цикл
		...
		ЭлементБлокировки = Блокировка.Добавить("Справочник.док_КонтактныеЛицаКлиентов");
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Предупреждение,
				Метаданные.Справочники.док_КонтактныеЛицаКлиентов, КонтактноеЛицоПартнера.Ссылка, ТекстСообщения);
	...
	Параметры.ОбработкаЗавершена = ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(Параметры.Очередь, "Справочник.док_КонтактныеЛицаКлиентов");
