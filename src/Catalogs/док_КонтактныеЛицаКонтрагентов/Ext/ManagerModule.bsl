...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СсылкиКОбработке = УправлениеКонтактнойИнформацией.ОбъектыТребующиеОбновленияКонтактнойИнформации(
		Метаданные.Справочники.док_КонтактныеЛицаКонтрагентов);
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	КонтактноеЛицоПартнера = ОбновлениеИнформационнойБазы.ВыбратьСсылкиДляОбработки(Параметры.Очередь, "Справочник.док_КонтактныеЛицаКонтрагентов");
	...
	Пока КонтактноеЛицоПартнера.Следующий() Цикл
		...
		ЭлементБлокировки = Блокировка.Добавить("Справочник.док_КонтактныеЛицаКонтрагентов");
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(), УровеньЖурналаРегистрации.Предупреждение,
				Метаданные.Справочники.док_КонтактныеЛицаКонтрагентов, КонтактноеЛицоПартнера.Ссылка, ТекстСообщения);
	...
	Параметры.ОбработкаЗавершена = ОбновлениеИнформационнойБазы.ОбработкаДанныхЗавершена(Параметры.Очередь, "Справочник.док_КонтактныеЛицаКонтрагентов");
