...
Процедура ЗаполнитьДерево(Копирование = Ложь,ПользовательИсточникКопирования = Неопределено)
	...
	|ИЗ
	|	ПланВидовХарактеристик.док_СправочникиДляШифрования КАК СправочникиДляШифрования
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.док_СправочникиДляШифрования КАК ЗначенияСправочникиДляШифрования
...
Процедура ЗаписатьНастройки()
	...
	Набор = РегистрыСведений.док_СправочникиДляШифрования.СоздатьНаборЗаписей();
	ДеревоНастроек = РеквизитФормыВЗначение("ДеревоНастроек_");
...
Процедура ОткрытьРегистрНастроек(Команда)
	ОткрытьФорму("РегистрСведений.док_СправочникиДляШифрования.Форма.ФормаСписка");
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьСписокНастроек(Команда)
	ОткрытьФорму("ПланВидовХарактеристик.док_СправочникиДляШифрования.ФормаСписка");
КонецПроцедуры

&НаКлиенте
Процедура ОбработатьПароли(Команда)
	док_ШифрованиеДанныхКлиент.ОбработатьПароли();
КонецПроцедуры
