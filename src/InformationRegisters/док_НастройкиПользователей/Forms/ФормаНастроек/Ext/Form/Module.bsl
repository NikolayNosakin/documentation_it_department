...
Процедура ЗаполнитьДерево(Копирование = Ложь,ПользовательИсточникКопирования = Неопределено)
	...
	|ИЗ
	|	ПланВидовХарактеристик.док_ПраваИНастройки КАК ПраваИНастройки
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.док_НастройкиПользователей КАК НастройкиПользователей
...
Процедура ЗаписатьНастройки()
	...
	Набор = РегистрыСведений.док_НастройкиПользователей.СоздатьНаборЗаписей();
...
Процедура ОткрытьРегистрНастроек(Команда)
	ОткрытьФорму("РегистрСведений.док_НастройкиПользователей.Форма.ФормаСписка");
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьСписокНастроек(Команда)
	ОткрытьФорму("ПланВидовХарактеристик.док_ПраваИНастройки.ФормаСписка");
КонецПроцедуры
