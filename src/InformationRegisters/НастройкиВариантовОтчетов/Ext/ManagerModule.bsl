...
Процедура ОповеститьПользователейВариантаОтчета(Записи) Экспорт 
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Варианты отчетов.Оповещение о предоставлении доступа к варианту отчета';
				|en = 'Report options.Notification on granting access to report option'", КодОсновногоЯзыка),
