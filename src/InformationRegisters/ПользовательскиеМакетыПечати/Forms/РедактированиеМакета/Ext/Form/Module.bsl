...
Процедура УстановитьНазваниеПрограммыДляОткрытияМакета()
	...
	ПерейтиНаСтаницуПрограммы = НСтр("ru = 'Перейти на страницу программы ""%1"" для установки';
									|en = 'Open the %1 installation page'");
	...
	Если Параметры.ТолькоОткрытие Тогда
		Элементы.НадписьПередЗагрузкойМакетаПрограммаВебКлиент.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Файл макета ""%1"" подготовлен для загрузки на компьютер и открытия с помощью другой программы.
				 |
				 |Если программа для редактирования еще не установлена, рекомендуется установить ""%2"".';
				 |en = 'The ""%1"" template file is prepared to be imported to the computer and opened using another application.
				 |
				 |If the editor is not installed yet, we recommend that you install %2.'"), ПредставлениеМакета,
				НазваниеПрограммыДляОткрытияМакета);
	Иначе
		Элементы.НадписьПередЗагрузкойМакетаПрограммаВебКлиент.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Файл макета ""%1"" подготовлен для загрузки на компьютер и внесения изменений с помощью другой программы.
				 |
				 |Если программа для редактирования еще не установлена, рекомендуется установить ""%2"".';
				 |en = 'The ""%1"" template file is prepared to be imported to the computer and edited using another application.
				 |
				 |If the editor is not installed yet, we recommend that you install %2.'"), ПредставлениеМакета,
				НазваниеПрограммыДляОткрытияМакета);
	КонецЕсли;
	...
	Элементы.НадписьПередЗагрузкойМакетаПрограммаНеВебКлиент.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Файл макета ""%1"" подготовлен для внесения изменений с помощью другой программы. Если программа для редактирования еще не установлена, рекомендуется установить ""%2"".';
			|en = 'The ""%1"" template file is prepared to be edited using another application. If the editor is not installed yet, we recommend that you install %2.'"), 
	...
	Элементы.НадписьЗавершениеИзмененияВебКлиент.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Дождитесь окончания загрузки файла макета, затем откройте и отредактируйте его.
			 ...
			 |
			 |Если программа для редактирования еще не установлена, рекомендуется установить ""%1"".';
			 |en = 'Please wait until the template file is imported, then open and edit it.
			 |
			 ...
			 |
			 |If the editor is not installed yet, we recommend that you install %1.'"), НазваниеПрограммыДляОткрытияМакета);
	...
	Элементы.НадписьЗавершениеИзмененияНеВебКлиент.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Дождитесь открытия макета в программе для редактирования.
			 ...
			 |
			 |Если программа для редактирования еще не установлена, рекомендуется установить ""%1"".';
			 |en = 'Please wait until the template is opened in the editor.
			 |
